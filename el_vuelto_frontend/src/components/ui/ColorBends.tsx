...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    renderer.setClearColor(0xfff8f0, transparent ? 0 : 1);
    ...
    // Initial call + deferred call for after layout
    handleResize();
  ...
  return <div ref={containerRef} className={['color-bends-container', className].filter(Boolean).join(' ')} style={style} />;
}
