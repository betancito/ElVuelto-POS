...
| — (pedido directo, sin prompt) | feature/ux 🖨️ | [[POS-20260827-caja-1366x768-y-reposo]] | 🟡 corrido-parcial | 2026-08-27 | ⚠️ 5 tareas entregadas (POS en 1366×768, `.exe` fullscreen, modo reposo, recibo térmico y vaciado con confirmación), pero la corrida **se cerró un día después**: la madrugada se quedó sin tokens antes de anexar la revisión adversarial. Al re-verificar contra código real, **4 de 7 arreglos aguantan y 3 no** → [[POS-20260827-tres-arreglos-a-medias]]. ⚠️ nada verificado en pantalla (sin navegador) | [[RUN-20260827-caja-adulto-mayor-y-recibo]] |
